            ...
            <form action="{{ route('feedback.store', $complaint) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <div class="flex justify-center space-x-2 mb-4" id="rating-stars">
                        @for($i = 1; $i <= 5; $i++)
                            <button type="button" class="rating-star text-3xl focus:outline-none" data-rating="{{ $i }}">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="file" class="flex flex-col items-center justify-center w-full h-32 border-2 border-emerald-300 border-dashed rounded-lg cursor-pointer bg-emerald-50 hover:bg-emerald-100 transition-colors">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-emerald-700"><span class="font-semibold">Click to upload</span> or drag and drop</p>
                                <p class="text-xs text-emerald-600">JPG, PNG, PDF, DOC (Max: 10MB)</p>
                            </div>
